...
def Index(request):
    #here we use simple filter method and Q Function
    '''
    ...
    #here we use exclude, values and values_list
    '''
    ...
    #here we use order_by method and distinct to stop repeat some packages
    '''
